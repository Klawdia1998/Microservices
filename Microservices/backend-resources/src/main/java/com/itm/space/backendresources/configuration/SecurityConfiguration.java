...
public class SecurityConfiguration {
    ...
    //цепочка фильтров безопасности для HTTP-запросов,
    // аутентификация через JWT и доступ к ресурсам на основе ролей пользователя
    ...
    //Создает новый объект JwtAuthenticationToken с JWT, коллекцией ролей и именем пользователя
}
