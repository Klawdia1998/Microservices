...
//код настраивает документацию API с использованием OpenAPI, включая схему безопасности OAuth2
// с кодом авторизации, и определяет конфигурацию OpenAPI для документации API